...
class BackgroundManagerDialog(QDialog):
    def __init__(self):
        ...
        self.listWidget.setAccessibleName("List of backgrounds")
        self.addButton = QPushButton("Add Background")
        self.addButton.setAccessibleName("Import Background")
        self.renameButton = QPushButton("Rename Selected")
        self.addButton.setAccessibleName("Rename Selected Background")
